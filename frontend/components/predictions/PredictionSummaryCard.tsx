...
export const PredictionSummaryCard: React.FC<{ prediction: DiseasePrediction }> = ({
  ...
  return (
    <Card className="p-4 sm:p-5 border border-[#F0FDFA] bg-white flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
      ...
      <Link
        ...
        className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#0D9488] hover:underline focus-ring rounded p-1"
      >
