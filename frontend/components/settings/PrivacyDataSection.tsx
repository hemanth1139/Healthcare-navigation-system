...
export const PrivacyDataSection: React.FC = () => {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="bg-[#F0FDFA]/60 dark:bg-[#0D9488]/15 border border-[#0D9488]/20 rounded-2xl p-4 sm:p-5 flex flex-col gap-3">
        <div className="flex items-center gap-2">
          <ShieldCheck className="w-5 h-5 text-[#0D9488] dark:text-[#14B8A6]" />
          <h3 className="font-heading font-bold text-sm text-[#0F172A] dark:text-[#F8FAFC]">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pt-2">
        ...
        <Link
          href="/privacy"
          className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#0D9488] dark:text-[#14B8A6] hover:underline focus-ring rounded p-1"
        >
      ...
      {downloadToast && (
        <div
          role="region"
          aria-live="polite"
          className="bg-[#0D9488] text-white p-3 rounded-xl text-xs font-semibold shadow-clinical flex items-center gap-2 animate-in fade-in"
        >
