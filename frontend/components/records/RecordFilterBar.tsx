    ...
    <div className="bg-white border-2 border-[#F0FDFA] rounded-2xl p-4 sm:p-5 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-4">
      ...
      <div className="flex flex-wrap items-center gap-3 flex-1">
        ...
        <select
          ...
          className="font-body text-xs text-[#0F172A] bg-[#F8FAFC] border border-[#F0FDFA] rounded-xl px-3 py-2 focus-ring cursor-pointer"
        >
        ...
        {/* Date Sort */}
        <div className="flex items-center gap-1.5 text-xs font-semibold text-[#64748B] ml-0 sm:ml-2">
        ...
        <select
          ...
          className="font-body text-xs text-[#0F172A] bg-[#F8FAFC] border border-[#F0FDFA] rounded-xl px-3 py-2 focus-ring cursor-pointer font-mono"
        >
      ...
      <div className="flex items-center justify-between sm:justify-end gap-3 pt-2 sm:pt-0 border-t sm:border-t-0 border-[#F0FDFA]">
        <span className="text-xs font-mono font-bold text-[#0D9488] bg-[#F0FDFA] px-2.5 py-1 rounded-full">
          {totalCount} Records
        </span>

        <div className="flex items-center gap-1 bg-[#F8FAFC] p-1 rounded-xl border border-[#F0FDFA]">
          <button
