            ...
            >
              <div className="flex flex-col gap-1.5">
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="text-xs font-mono font-bold text-[#0D9488] bg-[#F0FDFA] px-2.5 py-0.5 rounded-full">
                    {item.dosage}
                  </span>
                </div>
                ...
                <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-[#64748B]">
                  <span className="flex items-center gap-1 font-medium">
                    <Clock className="w-3.5 h-3.5 text-[#0D9488]" /> {item.frequency}
                  </span>
                  {item.prescribed_by && (
                    <span className="flex items-center gap-1">
                      <UserCheck className="w-3.5 h-3.5 text-[#64748B]" /> {item.prescribed_by}
                    </span>
                  )}
                </div>
              </div>
