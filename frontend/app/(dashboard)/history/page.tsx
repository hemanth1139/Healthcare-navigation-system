...
const TYPE_ICON: Record<ConsultationHistoryType, React.ReactNode> = {
  symptom_consultation: <Stethoscope className="w-4 h-4 text-blue-600" />,
    ...
    <div className="flex flex-col gap-6 max-w-5xl mx-auto py-2">
      ...
      {loading ? (
        <div className="flex flex-col items-center justify-center p-12 min-h-[300px]">
          ...
          <span className="text-xs text-[#5C6B6E] mt-2">Loading consultation history...</span>
        </div>
      ) : items.length === 0 ? (
              ...
              <div className="flex flex-col gap-3">
                {grouped[group].map((item) => {
                  ...
                  return (
                    <Card
                      key={item.id}
                      className="border border-slate-100 hover:border-blue-200 hover:shadow-sm transition-all p-4 flex flex-col gap-3"
                    >
                      ...
                      {isConsultation && (
                        <button
                          ...
                          className="flex items-center gap-1 text-xs font-semibold text-blue-600 hover:underline self-start"
                        >
